...
{
    public class AdventureCategoryUpdateDTO
    {
    ...
    public class AdventureCategoryUpdateDTOValidator : AbstractValidator<AdventureCategoryUpdateDTO>
    {
        public AdventureCategoryUpdateDTOValidator()
        {
            RuleFor(x => x.Name)
