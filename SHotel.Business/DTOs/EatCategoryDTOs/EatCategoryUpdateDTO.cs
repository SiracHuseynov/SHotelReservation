...
{
    public class EatCategoryUpdateDTO
    {
    ...
    public class EatCategoryUpdateDTOValidator : AbstractValidator<EatCategoryUpdateDTO>
    {
        public EatCategoryUpdateDTOValidator()
        {
            RuleFor(x => x.Name)
